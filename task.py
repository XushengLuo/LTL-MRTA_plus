...
class Task(object):
    def __init__(self):
        ...
        # ----------------- case 1 --------------------
        # n = 3  # int(sys.argv[1])
        # self.formula = '[]<> (l1_1_{0}_0 && l1_2_{0}_0) && []<> (l2_2_{0}_0 && l2_3_{0}_0) && ' \
        #                '[]<> (l3_3_{0}_0 && l3_4_{0}_0) && []<> (l4_4_{0}_0 && l4_5_{0}_0)'.format(n // 3)
        # self.ap = [[['l1', 1, n // 3], ['l1', 2, n // 3]], [['l2', 2, n // 3], ['l2', 3, n // 3]],
        #            [['l3', 3, n // 3], ['l3', 4, n // 3]], [['l4', 4, n // 3], ['l4', 5, n // 3]]]
        ...
        # self.ap = [[['l1', 1, 1], ['l5', 3, 1]], [['l2', 2, 2]], [['l4', 3, 2]]]        # self.formula = '<> (l1_1_2_0 && X<> l2_1_1_0) && <> l3_1_1_0'
        ...
        # self.formula = '<> (l1_1_2_0 && X <> l3_1_1_0) && <> l2_2_1_0'
        ...
        #            [['l10', 5, 1]]]
        # case 2 in RSS
        self.formula = '[]<> (l1_1_3_0 && l4_4_4_0) && <> (l2_3_3_1 && (l2_3_3_1 U l2_4_1_0) && <> l3_3_4_0)' \
                       '&& <> (l7_2_2_0 && (l8_5_3_2 || l10_5_3_2) && X <> l9_5_3_2) && <>[] l10_2_1_0'
        self.ap = [[['l1', 1, 3], ['l4', 4, 4]], [['l2', 3, 3]], [['l2', 4, 1]], [['l3', 3, 4]],
                    [['l7', 2, 2], ['l8', 5, 3]], [['l7', 2, 2], ['l10', 5, 3]], [['l9', 5, 3]],
                   [['l10', 2, 1]]]
        # self.formula = '<> (l2_3_3_2 && (l2_3_3_2 U l6_4_1_0) && <> l5_3_4_0)'
        # self.ap = [[['l2', 3, 3]], [['l6', 4, 1]], [['l5', 3, 4]]]
        #                '   [] <> l3_1_3_1 && [] <> l5_3_3_2 && []<> l6_4_2_0' \
        #                '&& <> (l7_4_3_0 && (l8_5_3_3 || l10_5_3_3) && X <> l9_5_3_3) && <>[] l10_5_1_0'
        # self.formula = '<> (l7_4_3_0 && (l8_5_3_3 || l10_5_3_3) && X <> l9_5_3_3) && <>[] l10_5_1_0'
        # self.ap = [[['l1', 1, 3], ['l4', 4, 4]], [['l2', 3, 3]], [['l3', 1, 3]], [['l5', 3, 3]],
        #            [['l6', 4, 2]], [['l7', 4, 3], ['l8', 5, 3]], [['l7', 4, 3], ['l10', 5, 3]], [['l9', 5, 3]],
